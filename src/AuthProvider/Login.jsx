  ...
  const handlegogle=()=>{
    ...
    return (
        <div>
            <NavLogin></NavLogin>
            <Nav></Nav>
            <div className="mt-24 flex justify-around md:flex-row flex-col">
<div>
<div className="form-container">
  ...
  <p className="sign-up-label text-xl">
    Are you new to here?<Link className="text-red-500 font-bol" to={'/res'}>Register</Link>
  </p>
  <div className="buttons-container">
   
    <div onClick={handlegogle} className="btn google-login-button">
...
<div>
  <img className="w-[350px] h-[360px]" src="https://i.ibb.co/27PkT61/log.jpg" alt="" />
</div>
      </div>
