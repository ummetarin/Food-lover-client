...
<div className="card">
 ...
 <div className="flex md:flex-row flex-col justify-center gap-24 mt-12  md:ml-1 ml-44">
 <div className="card">
  <div className="card-inner">
    <div className="card-front">
...
<div className="card">
 ...
 <div className="flex md:flex-row flex-col justify-center mt-12 gap-12  md:ml-1 ml-44">
 <div className="card">
  <div className="card-inner">
    <div className="card-front">
